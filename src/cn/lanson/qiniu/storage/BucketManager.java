...
public final class BucketManager {
    /**
     * Auth 对象 该类需要使用QBox鉴权，所以需要指定Auth对象
     */
    private final Auth auth;

    /**
     * Configuration 对象 该类相关的域名配置，解析配置，HTTP请求超时时间设置等
     */

    private final Configuration configuration;

    /**
     * HTTP Client 对象 该类需要通过该对象来发送HTTP请求
     */
    ...
    public FileListing listFiles(String bucket, String prefix, String marker, int limit, String delimiter) throws QiniuException {
        StringMap map = new StringMap().put("bucket", bucket).putNotEmpty("marker", marker).putNotEmpty("prefix", prefix).putNotEmpty("delimiter", delimiter)
     ...
     * @throws QiniuException
     */
    public void rename(String bucket, String oldFileKey, String newFileKey, boolean force) throws QiniuException {
     ...
     */
    public void rename(String bucket, String oldFileKey, String newFileKey) throws QiniuException {
     ...
     * @throws QiniuException
     */
    public void copy(String fromBucket, String fromFileKey, String toBucket, String toFileKey, boolean force) throws QiniuException {
     ...
     * @throws QiniuException
     */
    public void move(String fromBucket, String fromFileKey, String toBucket, String toFileKey, boolean force) throws QiniuException {
        String from = encodedEntry(fromBucket, fromFileKey);
        String to = encodedEntry(toBucket, toFileKey);
