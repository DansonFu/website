...
public final class Response {
    ...
    private Response(okhttp3.Response response, int statusCode, String reqId, String xlog, String xvia, String address, double duration, String error,
            byte[] body) {
    ...
    public static Response create(okhttp3.Response response, String address, double duration) {
        ...
        return new Response(response, code, reqId, response.header("X-Log"), via(response), address, duration, error, body);
    }
    ...
    public String toString() {
        return String.format(Locale.ENGLISH, "{ResponseInfo:%s,status:%d, reqId:%s, xlog:%s, xvia:%s, adress:%s, duration:%f s, error:%s}", super.toString(),
                statusCode, reqId, xlog, xvia, address, duration, error);
    }
