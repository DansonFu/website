...
final class AutoZone extends Zone {
    ...
    /**
     * 首先从缓存读取Zone信息，如果没有则发�1�7�请求从接口查询
     */
    ...
    static class ZoneInfo {
        ...
        private ZoneInfo(String upHttp, String upBackupHttp, String upIpHttp, String iovipHttp, String upHttps, String upBackupHttps, String upIpHttps,
                String iovipHttps) {
            this.upHttp = upHttp;
        ...
        /*
         * {"ttl":86400, "http": { "io":["http://iovip.qbox.me"], "up":["http://up.qiniu.com","http://upload.qiniu.com",
    ...
    private static class ZoneIndex {
        ...
        public boolean equals(Object obj) {
            return obj == this || !(obj == null || !(obj instanceof ZoneIndex)) && ((ZoneIndex) obj).accessKey.equals(accessKey)
                    && ((ZoneIndex) obj).bucket.equals(bucket);
        }
    }
