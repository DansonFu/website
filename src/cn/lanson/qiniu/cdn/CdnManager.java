...
/**
 * 该类主要提供CDN相关功能的接口实现，包括文件和目录的刷新，文件的预取，获取CDN访问日志链接，生成七牛时间戳防盗链等功能〄1�7
 */
public final class CdnManager {
    ...
    /**
     * 刷新目录列表，每次最多不可以超过10个目彄1�7 刷新目录霄1�7要额外开通权限，可以联系七牛抄1�7术支持处琄1�7
     *
     * @return 刷新请求的回处1�7
     * @link http://developer.qiniu.com/fusion/api/cache-refresh
     */
     ...
     * @param fileName 待访问的原始文件名，必须是utf8编码，不霄1�7要进行urlencode
     * @param queryStringMap 业务自身的查询参数，必须是utf8编码，不霄1�7要进行urlencode
     * @param encryptKey 时间戳防盗链的签名密钥，从七牛后台获叄1�7
     * @param deadline 链接的有效期时间戳，是以秒为单位的Unix时间戄1�7
     * @return signedUrl 朄1�7终的带时间戳防盗链的url
     * @link https://support.qiniu.com/question/195128
     */
    public static String createTimestampAntiLeechUrl(String host, String fileName, final StringMap queryStringMap, String encryptKey, long deadline)
